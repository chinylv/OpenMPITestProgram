...
int main (int argc, char * argv[]) {
  ...
  //seems that it has nothing to do with vsize?
  ...
  for(i = 0; i < local_nrows; i++) {
    // be aware that it is ncols, rather than ncols/nprocs
  ...
  //so in this way, we do not have to run different matvec according to my_rank
  ...
  //Be aware that the second vector is x, rather than local_x
